        ...
        <div ref={IntoPage} className="h-screen w-full m-auto justify-center flex items-center font-['Poppins']">
            ...
            <div className="w-full md:h-full h-[80%]  flex md:flex-row flex-col-reverse items-center justify-between">
                <div className="text-white ml-6 md:w-[60%] w-full h-full flex flex-col justify-center">
                    ...
                    viewport={{amount: 0.8}}
                    className="md:text-5xl text-2xl ml-6 font-semibold">Luthfie Arsya Darmaputra</motion.h1>
                    ...
                    viewport={{amount: 0.8}}
                    className="md:text-lg text-md ml-6 italic">FrontEnd Developer</motion.p>
                    ...
                    className="flex flex-row  w-full md:w-[40%]  items-center justify-start ml-6 h-16">
                        <PrimaryButton functionButton={() => ScrollIntoPage('about')} text={'About'} style={'w-28  h-10 mr-6 transition-all duration-300 hover:scale-110'}/>
                        <Secondary text={<a href={Cv} download={'LUTHFIE ARSYA DARMAPUTRA CV.pdf'}>Download CV</a>} style={'w-36 text-sm md:text-md h-10 transition-all duration-300 hover:scale-110'}/>
                    </motion.div>
                </div>
